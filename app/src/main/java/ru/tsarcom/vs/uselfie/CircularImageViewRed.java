...
public class CircularImageViewRed extends ImageView {
    ...
    public CircularImageViewRed(Context context) {
        super(context);
        setup();
    }
    public CircularImageViewRed(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup();
    }
    public CircularImageViewRed(Context context, AttributeSet attrs, int defStyle) {
